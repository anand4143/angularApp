...
export class HttpService extends Http {
  ...
  get(url: string, options?: RequestOptionsArgs, preloaderType?: string): Observable<any> {
    // console.log("get url: ", this.getFullUrl(url));
    this.requestInterceptor(preloaderType);
    // console.log("get - Before full URL")
    let fullUrl = this.getFullUrl(url);
    //console.log("get - After full URL: ", fullUrl, this.requestOptions(options))
    return super.get(fullUrl, this.requestOptions(options))
      .catch(this.onCatch)
      .do((res: Response) => {
        //console.log("get - Before onSubscribeSuccess: ", fullUrl)
        this.onSubscribeSuccess(res);
      }, (error: any) => {
        //console.log("get - Before onSubscribeError: ", fullUrl)
        this.onSubscribeError(error);
      })
      .finally(() => {
        //console.log("get - Before onFinally: ", fullUrl)
  ...
  private onFinally(preloaderType = 'full'): void {
    // console.log("Calling Response Interceptor");
